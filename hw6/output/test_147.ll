...
define i64 @program(i64 %_argc7606, { i64, [0 x i8*] }* %_argv7603) {
  %_unop7609 = add i64 -3, 0
  %_unop7610 = add i64 -4, 0
  %_unop7611 = add i64 -5, 0
  %_result7612 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop7611, i64 %_unop7610, i64 %_unop7609)
  ret i64 %_result7612
}
