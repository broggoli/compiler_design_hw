...
define i64 @program(i64 %_argc8869, { i64, [0 x i8*] }* %_argv8866) {
  %_x8876 = alloca i64
  %_unop8872 = sub i64 0, 3
  %_unop8873 = sub i64 0, 4
  %_unop8874 = sub i64 0, 5
  %_result8875 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop8874, i64 %_unop8873, i64 %_unop8872)
