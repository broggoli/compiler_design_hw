...
define i64 @program(i64 %_argc8922, { i64, [0 x i8*] }* %_argv8919) {
  %_unop8925 = add i64 -3, 0
  %_unop8926 = add i64 -4, 0
  %_unop8927 = add i64 -5, 0
  %_result8928 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop8927, i64 %_unop8926, i64 %_unop8925)
  ret i64 %_result8928
}
