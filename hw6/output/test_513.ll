...
define i64 @program(i64 %_argc7522, { i64, [0 x i8*] }* %_argv7519) {
  %_unop7525 = sub i64 0, 3
  %_unop7526 = sub i64 0, 4
  %_unop7527 = sub i64 0, 5
  %_result7528 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop7527, i64 %_unop7526, i64 %_unop7525)
  ret i64 %_result7528
}
