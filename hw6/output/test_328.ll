...
define i64 @program(i64 %_argc7469, { i64, [0 x i8*] }* %_argv7466) {
  %_x7476 = alloca i64
  %_unop7472 = add i64 -3, 0
  %_unop7473 = add i64 -4, 0
  %_unop7474 = add i64 -5, 0
  %_result7475 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop7474, i64 %_unop7473, i64 %_unop7472)
