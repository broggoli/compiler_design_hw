...
define i64 @program(i64 %_argc8965, { i64, [0 x i8*] }* %_argv8962) {
  %_unop8968 = sub i64 0, 3
  %_unop8969 = sub i64 0, 4
  %_unop8970 = sub i64 0, 5
  %_result8971 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop8970, i64 %_unop8969, i64 %_unop8968)
  ret i64 %_result8971
}
