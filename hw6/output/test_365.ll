...
define i64 @program(i64 %_argc9006, { i64, [0 x i8*] }* %_argv9003) {
  %_unop9009 = add i64 -3, 0
  %_unop9010 = add i64 -4, 0
  %_unop9011 = add i64 -5, 0
  %_result9012 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop9011, i64 %_unop9010, i64 %_unop9009)
  ret i64 %_result9012
}
