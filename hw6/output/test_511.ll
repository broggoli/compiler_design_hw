...
define i64 @program(i64 %_argc7420, { i64, [0 x i8*] }* %_argv7417) {
  %_unop7423 = sub i64 0, 3
  %_unop7424 = sub i64 0, 4
  %_unop7425 = sub i64 0, 5
  %_result7426 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop7425, i64 %_unop7424, i64 %_unop7423)
  ret i64 %_result7426
}
