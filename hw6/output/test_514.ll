...
define i64 @program(i64 %_argc7565, { i64, [0 x i8*] }* %_argv7562) {
  %_unop7568 = sub i64 0, 3
  %_unop7569 = sub i64 0, 4
  %_unop7570 = sub i64 0, 5
  %_result7571 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop7570, i64 %_unop7569, i64 %_unop7568)
  ret i64 %_result7571
}
