...
define i64 @program(i64 %_argc8820, { i64, [0 x i8*] }* %_argv8817) {
  %_unop8823 = add i64 -3, 0
  %_unop8824 = add i64 -4, 0
  %_unop8825 = add i64 -5, 0
  %_result8826 = call i64 @f(i64 1, i64 2, i64 3, i64 4, i64 5, i64 %_unop8825, i64 %_unop8824, i64 %_unop8823)
  ret i64 %_result8826
}
