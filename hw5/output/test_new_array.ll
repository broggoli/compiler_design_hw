...
define i8* @program() {
  ...
  br label %_cond5
_cond5:
  %_i8 = load i64, i64* %_i7
  %_bop9 = icmp slt i64 %_i8, 5
  br i1 %_bop9, label %_body4, label %_post3
_body4:
  %_local_id6 = load i64, i64* %i
  %index_ptr = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array2, i32 0, i32 1, i64 %_local_id6
  %_i10 = load i64, i64* %_i7
  store i64 %_i10, i64* %_index_ptr12
  %_bop11 = add i64 %_local_id13, 1
  store i64 %_bop11, i64* %i
  br label %_cond5
_post3:
