...
define i64 @program(i64 %_argc181, { i64, [0 x i8*] }* %_argv179) {
  ...
  %_index_ptr191 = getelementptr %Test, %Test* %_struct184, i32 0, i32 1, i32 2
  store { i64, [3 x i64] }* %_arr_z190, { i64, [3 x i64] }** %_index_ptr191
  %_index_ptr188 = getelementptr %Test, %Test* %_struct184, i32 0, i32 1, i32 1
  store i64 3, i64* %_index_ptr188
  %_arr_x185 = load { i64, [3 x i64] }*, { i64, [3 x i64] }** @arr_x
  %_index_ptr186 = getelementptr %Test, %Test* %_struct184, i32 0, i32 1, i32 0
  store { i64, [3 x i64] }* %_arr_x185, { i64, [3 x i64] }** %_index_ptr186
  store %Test* %_struct184, %Test** %_t193
  %_t194 = load %Test*, %Test** %_t193
  %_index_ptr195 = getelementptr %Test, %Test* %_t194, i32 0, i32 1, i32 0
  %_field_op196 = load { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_ptr195
  %_proj197 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_field_op196
  ...
  %_index_ptr203 = getelementptr %Test, %Test* %_t202, i32 0, i32 1, i32 2
  %_field_op204 = load { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_ptr203
  %_proj205 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_field_op204
